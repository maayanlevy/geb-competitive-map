...
def create_competitive_map(df):
    ...
    <div class="axis-label" style="top: 50%; left: 0px; transform: rotate(-90deg) translateY(-50%);">Generic Processes</div>
    <div class="axis-label" style="top: 50%; right: 15px; transform: rotate(90deg) translateY(-50%);">My Processes</div>
    """
